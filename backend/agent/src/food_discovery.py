...
INTENTS_DATA: dict[IntentKey, IntentEntry] = {
    "healthy": {
...
RESULTS_DATA: dict[str, list[FoodCard]] = {
    "healthy": [
        HealthyFoodCard(
            ...
            badge=Badge(text="Macro match", color="#16A34A", bg="#DCFCE7"),
        ...
        HealthyFoodCard(
            ...
            badge=Badge(text="Top rated", color="#D97706", bg="#FEF9C3"),
        ...
        HealthyFoodCard(
            ...
            badge=Badge(text="Fastest", color="#2563EB", bg="#DBEAFE"),
    ...
    "comfort": [
        ComfortFoodCard(
            ...
            badge=Badge(text="❤️ Most loved", color="#DC2626", bg="#FEF2F2"),
        ...
        ComfortFoodCard(
            ...
            badge=Badge(text="📈 Trending", color="#EA580C", bg="#FFF7ED"),
        ...
        ComfortFoodCard(
            ...
            badge=Badge(text="⚡ Quick comfort", color="#374151", bg="#F3F4F6"),
    ...
    "light": [
        LightFoodCard(
            ...
            badge=Badge(text="310 kcal", color="#2563EB", bg="#DBEAFE"),
            name="Niçoise Salad",
        ...
        LightFoodCard(
            ...
            badge=Badge(text="220 kcal", color="#2563EB", bg="#DBEAFE"),
        ...
        LightFoodCard(
            ...
            badge=Badge(text="380 kcal", color="#2563EB", bg="#DBEAFE"),
    ...
    "unsure": [
        UnsureFoodCard(
            ...
            badge=Badge(text="✦ AI pick", color="#7C3AED", bg="#F5F3FF"),
        ...
        HealthyFoodCard(
            ...
            emoji="🥗",
            bg="linear-gradient(135deg,#D1FAE5,#6EE7B7)",
            badge=Badge(text="Balanced", color="#16A34A", bg="#DCFCE7"),
            name="Grilled Chicken Power Bowl",
            restaurant="Clean Kitchen Co.",
            rating="4.8",
            calories=420,
